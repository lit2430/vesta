package com.vesta.adapter.mysql;

import com.alibaba.druid.pool.DruidDataSourceFactory;
import com.google.common.collect.Lists;
import com.vesta.common.enums.ErrorCodeEnum;
import com.vesta.common.exception.BaseException;
...
public class DruidJdbcUtils {
    ...
    private Connection getConnect() {
        try {
            ...
            throw new BaseException(ErrorCodeEnum.DRUID_JDBC_CONNECT_OBTAIN_FAILED, sex);
        } catch (Exception e) {
            log.error("druid datasource init failed:{}", e.getMessage());
            throw new BaseException(ErrorCodeEnum.DRUID_DATASOURCE_INIT_FAILED, e);
        }
    }
    ...
    public List<Map<String, Object>> execQuery(String sql) {
        ...
        try {
            ...
            if (resultSet == null) {
                throw new BaseException(ErrorCodeEnum.QUERY_SQL_RESULT_ERROR);
            }
            ...
            throw new BaseException(ErrorCodeEnum.QUERY_SQL_RESULT_ERROR, sex);
        }
        return resultList;
    }
